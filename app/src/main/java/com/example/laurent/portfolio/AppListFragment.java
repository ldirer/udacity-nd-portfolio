package com.example.laurent.portfolio;
...
//        fragment.setArguments(args);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayAdapter<String> appsAdapter = new ArrayAdapter<>(
                getActivity(), R.layout.button_app, R.id.list_app_button, apps
        );
        ListView appListView = (ListView) rootView.findViewById(R.id.list_app);
